...
test_that('Correct values are generated by getSimulatedExpr', {
  exprGroups = data.table::data.table(meanExpr = c(4), dExpr = c(2),
                                      meanAmp = c(4), dAmp = c(2),
                                      meanPhase = c(4), dPhase = c(2),
                                      meanSd = c(0), dSd = c(0))
  simGse = getSimulatedExpr(exprGroups, nGenes = 2, nRep = 1, period = 24,
                            interval = 12)
...
test_that('Outputs are of correct type and there are no NA values - Expr', {
...
test_that('Outputs are of correct type and there are no NA values - GeneCount', {
  exprGroups = data.table::data.table(meanExpr = c(4))
  simGse = getSimulatedGeneCount(exprGroups)
